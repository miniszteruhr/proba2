...
<div id="app">
    ...
    <div>
        <select class="addRowTo"v-model="selectedOption" @change="toggleForm">
            <option class="dropdown" value="kitörők">WINGS</option>
            <option class="dropdown" value="rudak">POLES</option>
        </select>
    </div>
    <div id="formContainer" v-show="showForm">
        <form @submit.prevent="addRow">
            ...
            <label for="darabszam" class="form-label">Number:</label>
    ...
    <div>
        <button class="button" @click="moveToWarehouse">Storage</button> <br>
        <button class="buttondel" @click="deleteSelectedRow">Delete</button> <br>
    </div>
